...
namespace :monitoring do
  task :snmp, [:base_oid] => :environment do |_task, args|
    ...
    script.variable_store.add_list(args[:base_oid], {
      ...
      '2.4.1' => SNMPPass::Variable::Gauge.new(getter: proc { cached_status[:cache][:cache_hits_percent] }),
      ...
      '2.5.1' => SNMPPass::Variable::Gauge.new(getter: proc { cached_status[:cache][:cache_misses_percent] }),
