==Build State
This project uses continuous integration to help ensure that a quality product is delivered. It is tested using ruby 1.9.3 other versions may work but are not guarenteed (since they aren't tested).
