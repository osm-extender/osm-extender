Master branch:
{<img src="https://secure.travis-ci.org/osm-extender/osm-extender.png?branch=master"/>}[http://travis-ci.org/osm-extender/osm-extender]
{<img src="https://coveralls.io/repos/osm-extender/osm-extender/badge.png?branch=master" />}[https://coveralls.io/r/osm-extender/osm-extender]
{<img src="https://codeclimate.com/github/osm-extender/osm-extender.png?branch=master" />}[https://codeclimate.com/github/osm-extender/osm-extender]

Staging branch:
{<img src="https://secure.travis-ci.org/osm-extender/osm-extender.png?branch=staging"/>}[http://travis-ci.org/osm-extender/osm-extender]
{<img src="https://coveralls.io/repos/osm-extender/osm-extender/badge.png?branch=staging" />}[https://coveralls.io/r/osm-extender/osm-extender]
...
Please follow the information in the doc folder.
