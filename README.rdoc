{<img src="https://gemnasium.com/robertgauld/OSMExtender.png" alt="Dependency Status" />}[https://gemnasium.com/robertgauld/OSMExtender]

Master branch:
{<img src="https://secure.travis-ci.org/robertgauld/OSMExtender.png?branch=master"/>}[http://travis-ci.org/robertgauld/OSMExtender]
{<img src="https://coveralls.io/repos/robertgauld/osm/badge.png?branch=master" />}[https://coveralls.io/r/robertgauld/osm]
{<img src="https://codeclimate.com/github/robertgauld/OSMExtender.png?branch=master" />}[https://codeclimate.com/github/robertgauld/OSMExtender]

Staging branch:
{<img src="https://secure.travis-ci.org/robertgauld/OSMExtender.png?branch=staging"/>}[http://travis-ci.org/robertgauld/OSMExtender]
{<img src="https://coveralls.io/repos/robertgauld/osm/badge.png?branch=staging" />}[https://coveralls.io/r/robertgauld/osm]
{<img src="https://codeclimate.com/github/robertgauld/OSMExtender.png?branch=staging" />}[https://codeclimate.com/github/robertgauld/OSMExtender]
...
===Shared events
These allow several sections to use OSM to manage their attendance at a larger event whilst allowing the event orgabiser to see the details for all attendees accross all sections.
