...
Feature: Programme Wizard
	...
	Then I should see "This feature is now availible in OSM and so will be removed from here in a few months time."
        When I fill in "Programme start" with "2003-01-01"
	...
	Then I should see "This feature is now availible in OSM and so will be removed from here in a few months time."
        And I should see "Evening title can't be blank"
	...
	And I fill in "Programme interval" with "140"
        ...
        And I press "Create programme"
	Then I should see "This feature is now availible in OSM and so will be removed from here in a few months time."
        And I should see "Your programme was created"
